    ...
    <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-actions d-none d-xl-flex align-items-center list-unstyled mb-0">
                <li><button class="action__btn action__btn-search"><i class="fas fa-search"></i></button></li>
                <li>
                    <a href="#" class="action__btn action__btn-cart">
                        <i class="fas fa-cart-arrow-down"></i><span class="cart__counter">3</span>
                    </a>
                        ...
                        <ul class="list-unstyled">
                            <li class="cart-item">
                                ...
                                <div class="cart__content">
                                    <a class="cart__title" href="shop-single-product.html">Broom & Dustpan</a>
                            ...
                            <li class="cart-item">
                                ...
                                <div class="cart__content">
                                    <a class="cart__title" href="shop-single-product.html">Sponge Cleaner </a>
                ...
                <li>
                    <div class="phone__number">
                        ...
                        <div>
                            ...
                            <a class="email__link d-block" href="#"><span class="__cf_email__" data-cfemail="1447717f61667154237b667b7b723a777b79">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </li>
            </ul>
