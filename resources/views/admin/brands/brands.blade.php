                    ...
                    @endif
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ბრენდი</h3>
                                <a href="{{ url('admin/add-edit-brand') }}" style="max-width: 150px; float: right; display: inline-block;" class="btn btn-block btn-success">დამატება</a>
                            </div>
                            <div class="card-body">
