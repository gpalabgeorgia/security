                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="brand_name">Название Бренда</label>
                                        <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Введите Название Бренда" @if(!empty($brand['name'])) value="{{ $brand['name'] }}" @else value="{{ old('brand_name') }}" @endif>
                                    </div>
                                </div>
                            </div>
                        </div>
