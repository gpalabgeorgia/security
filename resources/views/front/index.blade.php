        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7 col-xl-6">
                ...
                <div class="about__Text">
                    ...
                    <p class="heading__desc mb-40">Don’t worry about anything, our security experts will install your new
                        system, activate
                        it, and show
                        you how to use it.</p>
                ...
                <div class="about__img">
                    ...
                    <div class="cta-banner">
                        ...
                        <ul class="list-items-layout5 list-unstyled mb-0">
                            <li class="list__item">Easy to and use</li>
                ...
                <div class="about__text">
                    <div class="heading-layout1 heading-light mb-60">
                        ...
                        <p class="heading__desc mb-30">Our experts have undertaken system projects of all sizes and scopes,
                            ...
                            corporate campus.</p>
                        <p class="heading__desc mb-30">With over 60 offices across the World, we are leading the security system
                            integrators with a global reach and local touch. </p>
                    </div><!-- /heading -->
                    <blockquote class="blockquote mb-0">
                        <h3 class="quote__title color-white">The peace of mind I have now is so comforting, knowing when I leave
        ...
        <div class="row heading mb-20">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
                <p class="heading__desc mb-30">For the Security and IT directors ensuring our places of
                    work and leisure are safe. For the Chief Technology Officers shaping the smart businesses of tomorrow. We deliver powerful and insightful security solutions that enable protectors to drive forward.</p>
                            ...
                            <div class="portfolio__body">
                                ...
                                <div class="portfolio__info">
                                    ...
                                    <p class="portfolio__desc">The systems feature manual call and sounder devices wirelessly linked
                                        to
                                        main
                                        panel. Whilst wireless systems are more expensive than hardwired standard versions, they negate
                                        the...</p>
                                </div>
                    ...
                    <form class="contact-panel__form" method="post" action="#" id="contactForm">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="contact-panel__desc mb-30">Please complete the form below, to request a quote, and we’ll
                            ...
                            <div class="h-100">
                                <div class="pricing-package">
                                    <div class="package__body">
                                        ...
                                        <p class="package__desc">Our highly trained technicians will  your security system so you
                                            don’t
